...
export const MOCK_ADMIN: DashboardAdminPayload = {
  ...
  mix_receita: [
    { source: "Atendimentos", source_key: "atendimentos", value_cents: 247_000, pct: 64.5 },
    { source: "Assinaturas",  source_key: "assinaturas",  value_cents: 122_300, pct: 31.9 },
    { source: "Produtos",     source_key: "produtos",     value_cents:   8_500, pct:  2.2 },
    { source: "Outros",       source_key: "outros",       value_cents:   5_000, pct:  1.3 },
  ],
