        ...
        {formStep === 'checkout' && (() => {
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className={`flex-1 h-px ${checkoutSubStep === 'card' ? 'bg-emerald-500' : 'bg-zinc-800'}`} />
              <div className={`flex items-center gap-1.5 ${checkoutSubStep === 'card' ? 'text-primary' : 'text-zinc-600'}`}>
                <div className={`w-2 h-2 rounded-full ${checkoutSubStep === 'card' ? 'bg-primary' : 'bg-zinc-800'}`} />
            ...
            {checkoutSubStep === 'address' ? (
              ...
              <div className="space-y-2">
                ...
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-3 flex justify-between items-center">
